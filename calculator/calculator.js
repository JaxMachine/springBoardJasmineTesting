...
function setupIntialValues() {
  ...
  const enteredYears = document.getElementById("loan-years");
  enteredYears.value = values.years;
...
function update() {
  const currentEnteredValues = getCurrentUIValues();
  updateMonthly(calculateMonthlyPayment(currentEnteredValues));
}
...
function updateMonthly(monthly) {
  ...
  if(monthly === 'NaN'){
    monthlyOutput.innerText = 'Enter A Valid number';
  }else{
